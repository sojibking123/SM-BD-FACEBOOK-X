...
from concurrent.futures import ThreadPoolExecutor as MORADssb
from string import * 
...
\033[1;91m ╚══════╝╚═╝     ╚═╝      ╚═════╝ ╚═════╝ 
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            ❐⊰༎⊱SM-BD⊰༎⊱❐
\033[1;37m Facebook:            KING MORAD
\033[1;37m Github  :            MORAD-KHAN-BS
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with MORADssb(max_workers=30) as ssbworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def cutter():
    ...
    print(" ")
    MORAD = input('Saving Put File Name :')
    os.system('touch ' +MORAD)
    os.system('sort -r '+ssb+' | uniq > '+MORAD)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + ssb )
    print(47*'-')
    print("File Saved To :" + MORAD )
    print(47*'-')
